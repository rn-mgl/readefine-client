...
const Signup = () => {
  ...
  return (
    <div className="w-full h-screen bg-prmColor p-4 cstm-flex-col  ">
      ...
      <br />
      <form
        className="w-full rounded-md bg-scndColor bg-opacity-20 backdrop-blur-md border-2 
                  border-scndColor border-opacity-40 p-4 cstm-flex-col gap-4 relative z-10 shadow-lg
                    t:w-96
                    l-s:w-[26rem]"
        onSubmit={signUp}
      >
