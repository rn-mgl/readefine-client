...
const SingleUser = ({ params }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-accntColor cstm-flex-col justify-start p-5 gap-4">
      ...
      <div className="cstm-flex-col gap-4 w-full cstm-w-limit">
        ...
        <div className="cstm-flex-col gap-4 w-full min-h-screen justify-start">
          {/* graph for lexile */}
          <div className="cstm-flex-col p-5 w-full bg-white rounded-2xl gap-4 items-start">
            <SelectFilter
