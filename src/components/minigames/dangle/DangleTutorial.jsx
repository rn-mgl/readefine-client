...
import { BsDot, BsFillLightbulbFill, BsPatchQuestionFill, BsPlusSlashMinus } from "react-icons/bs";
  ...
  return (
    <div
      className="w-full fixed top-0 left-0 min-h-screen h-full backdrop-blur-md bg-gradient-to-br 
              from-[#552aca32] to-[#4bfce132] z-[60] cstm-flex-col justify-start
                p-4 animate-[fadeIn_200ms] overflow-y-auto cstm-scrollbar-2"
    >
      ...
      <div className="cstm-flex-col w-full h-auto">
        <div className="cstm-flex-col justify-start w-full gap-4 t:w-10/12 l-s:w-8/12 l-l:w-6/12 ">
          ...
          >
            ...
            >
              ...
              <p className="text-sm t:text-base">You will be given a random hidden word.</p>
            ...
            <div className="cstm-flex-col text-sm t:text-base w-full gap-4">
              ...
              <div className="cstm-flex-col w-full gap-2">
                <div className="cstm-flex-row gap-2 w-full">
                  ...
                  <p className="bg-black p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">A</p>
                  <p className="bg-black p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">P</p>
            ...
            <div className="cstm-flex-col text-sm t:text-base w-full gap-4">
              ...
              <div className="cstm-flex-col w-full gap-2 text-left">
                <p className="w-full">
                  If the letters you guessed are <b>not</b> in the word, the color will not change.
                </p>
                <div className="cstm-flex-row gap-2 w-full">
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">T</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">R</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">U</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">S</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">T</p>
                </div>
              </div>
              ...
              <div className="cstm-flex-col w-full gap-2 text-left">
                <p className="w-full">
                  If the letters you guessed are <b>in</b> the word, the font color will change.
                </p>
                <div className="cstm-flex-row gap-2 w-full">
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">L</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold text-prmColor">E</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">M</p>
                  <p className="bg-neutral-200 p-2 w-8 h-8 rounded-md cstm-flex-col font-bold">O</p>
              ...
              <div className="cstm-flex-col w-full gap-2 text-left">
                <p className="w-full">
                  If the letters you guessed are in the <b>correct position</b>, the font color and box color will
            ...
            >
              ...
              <p className="text-sm t:text-base">
                You can also use the hint to see the definition of the word you are guessing.
              </p>
