...
const AdminLink = (props) => {
  return (
    <Link
      ...
      } cstm-flex-row gap-5 w-full justify-start text-left p-2 font-poppins whitespace-nowrap text-sm hover:bg-black hover:bg-opacity-10 rounded-md transition-all`}
    >
