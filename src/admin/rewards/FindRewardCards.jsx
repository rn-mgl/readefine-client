...
const FindRewardCards = (props) => {
  return (
    <div className="bg-white shadow-md p-4 rounded-2xl cstm-flex-col gap-4 w-72 min-h-[24rem] h-[24rem] justify-start">
      <Image
        src={props.image}
        alt="temp"
        className="rounded-2xl bg-accntColor p-4 h-[16rem] overflow-clip saturate-150"
        width={250}
        height={250}
        priority
      />
