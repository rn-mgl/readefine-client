...
const LowLexileTestMessage = (props) => {
  return (
    <div className="w-full h-full backdrop-blur-md fixed top-0 left-0 z-[60] p-4">
      <div className="cstm-flex-col w-full h-full">
        <div className="bg-white rounded-2xl shadow-md w-full h-fit p-4 cstm-flex-col gap-4 text-justify text-sm relative t:w-6/12 l-s:w-5/12">
          ...
          <p className="text-prmColor font-bold underline underline-offset-2 text-base">Important</p>
          ...
          <p>
            You can <b className="text-prmColor">lower your current grade level</b> in your profile if you think your
            current Lexile level is <b className="text-prmColor">too challenging for now.</b>
          </p>
